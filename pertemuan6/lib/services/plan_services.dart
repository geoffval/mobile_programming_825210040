...
import 'package:structure_mvc/repositories/in_memory_cache.dart';
import 'package:structure_mvc/repositories/repository.dart';
...
class PlanServices{
  ...
  void addTask(Plan plan, String description){
    ...
    final tasl = Task(id: id, description: description);
    plan.tasks.add(task);
    savePlan(plan);
  }
